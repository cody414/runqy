...
sleep 0.3
echo "[INFO] Bootstrap successful: redis=localhost:6379, queue=quickstart-oneshot"
sleep 0.2
echo "[INFO] Deploying code from https://github.com/Publikey/runqy.git (branch: main)..."
sleep 0.3
echo "[INFO] Sparse checkout successful (only downloaded: examples/quickstart-oneshot)"
sleep 0.2
...
echo "[INFO] Bootstrap complete with 2 sub-queues (priority=5)"
